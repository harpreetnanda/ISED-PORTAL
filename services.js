...
.service ('tenantSvc', function ($http){
    var getMappingList = function (tid, sid){
        ...
        baseurl = 'https://backend-3scale-portal.df24.ised-dev.openshiftapps.com/threescale/tenants/' + tid + '/mappinglist/' + sid;
...
.service ('masterSvc', function ($http){
    var baseurl = 'https://backend-3scale-portal.df24.ised-dev.openshiftapps.com/threescale/tenants';
    var currTenant = "";
    var localTenants = [];
